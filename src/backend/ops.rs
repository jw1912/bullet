...
extern "C" {
    ...
    pub fn sparseLinearForward(batchSize: usize, maxInputSize: usize, outputSize: usize, weights: *const f32, inputs: *const i32, outputs: *mut f32);
    pub fn sparseLinearBackward(batchSize: usize, maxInputSize: usize, outputSize: usize, weightsGrad: *mut f32, inputs: *const i32, errors: *const f32);
}
