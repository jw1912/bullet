...
pub fn softmax_crossentropy_loss_masked(builder: &mut GraphBuilder, predicted: Node, target: Node, mask: Node) -> Node {
    builder.create_result_of_operation(Operation::SoftmaxCrossEntropyLoss, &[predicted, target, mask])
}
